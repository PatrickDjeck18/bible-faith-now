...
-- Insert comprehensive Bible quiz questions (100+ questions)
...
('Who was the strongest judge of Israel?', 'Gideon', 'Samson', 'Deborah', 'Jephthah', 1, 'Samson was the judge known for his incredible strength given by God.', 'history', 'medium', 'old', 'Judges', 'Judges 13-16'),
('What did God use to destroy Sodom and Gomorrah?', 'Flood', 'Fire and brimstone', 'Earthquake', 'Plague', 1, 'God destroyed Sodom and Gomorrah with fire and brimstone from heaven.', 'old_testament', 'medium', 'old', 'Genesis', 'Genesis 19:24'),
('How many brothers did Joseph have?', '10', '11', '12', '13', 1, 'Joseph had eleven brothers, making twelve sons of Jacob total.', 'old_testament', 'medium', 'old', 'Genesis', 'Genesis 35:22-26'),
('What was Moses'' brother''s name?', 'Aaron', 'Joshua', 'Caleb', 'Miriam', 0, 'Aaron was Moses'' brother and served as the first high priest of Israel.', 'old_testament', 'medium', 'old', 'Exodus', 'Exodus 4:14'),
('Which prophet was taken up to heaven in a chariot of fire?', 'Elijah', 'Elisha', 'Isaiah', 'Jeremiah', 0, 'Elijah was taken up to heaven in a whirlwind with chariots and horses of fire.', 'prophets', 'medium', 'old', '2 Kings', '2 Kings 2:11'),
...
('How many missionary journeys did Paul take?', '2', '3', '4', '5', 1, 'Paul took three major missionary journeys as recorded in the book of Acts.', 'epistles', 'medium', 'new', 'Acts', 'Acts 13-21'),
...
('Who was the first king of Israel?', 'David', 'Solomon', 'Saul', 'Samuel', 2, 'Saul was anointed as the first king of Israel by the prophet Samuel.', 'history', 'hard', 'old', '1 Samuel', '1 Samuel 10:1'),
('What was the name of Ruth''s mother-in-law?', 'Naomi', 'Rachel', 'Leah', 'Sarah', 0, 'Naomi was Ruth''s mother-in-law who returned to Bethlehem with Ruth.', 'old_testament', 'hard', 'old', 'Ruth', 'Ruth 1:4'),
('How many years did Solomon reign as king?', '30 years', '40 years', '50 years', '60 years', 1, 'King Solomon reigned for 40 years over Israel.', 'history', 'hard', 'old', '1 Kings', '1 Kings 11:42'),
('Which prophet had a vision of dry bones coming to life?', 'Isaiah', 'Jeremiah', 'Ezekiel', 'Daniel', 2, 'Ezekiel had the famous vision of the valley of dry bones coming to life.', 'prophets', 'hard', 'old', 'Ezekiel', 'Ezekiel 37:1-14'),
('Who was thrown into the fiery furnace?', 'Daniel', 'Shadrach, Meshach, and Abednego', 'Ezra and Nehemiah', 'David and Jonathan', 1, 'Shadrach, Meshach, and Abednego were thrown into the fiery furnace for refusing to worship the golden image.', 'old_testament', 'hard', 'old', 'Daniel', 'Daniel 3:20'),
...
('Who wrote the book of Job?', 'Job himself', 'Moses', 'Solomon', 'Unknown', 3, 'The author of Job is unknown, though it''s one of the oldest books in the Bible.', 'wisdom', 'hard', 'old', 'Job', 'N/A'),
...
('Which prophet confronted King David about his sin with Bathsheba?', 'Samuel', 'Nathan', 'Gad', 'Elijah', 1, 'The prophet Nathan confronted King David about his adultery with Bathsheba and murder of Uriah.', 'prophets', 'medium', 'old', '2 Samuel', '2 Samuel 12:1-14'),
...
('Which Gospel is the shortest?', 'Matthew', 'Mark', 'Luke', 'John', 1, 'Mark is the shortest of the four Gospels with only 16 chapters.', 'gospels', 'medium', 'new', 'Mark', 'N/A'),
('In which Gospel do we find the parable of the Good Samaritan?', 'Matthew', 'Mark', 'Luke', 'John', 2, 'The parable of the Good Samaritan is found only in the Gospel of Luke.', 'gospels', 'medium', 'new', 'Luke', 'Luke 10:25-37'),
('Which Gospel records the most parables?', 'Matthew', 'Mark', 'Luke', 'John', 0, 'Matthew records the most parables of Jesus, including many unique to his Gospel.', 'gospels', 'hard', 'new', 'Matthew', 'N/A'),
...
('Which book contains the "Armor of God" passage?', 'Romans', 'Ephesians', 'Colossians', 'Galatians', 1, 'The "Armor of God" passage is found in Ephesians chapter 6.', 'epistles', 'medium', 'new', 'Ephesians', 'Ephesians 6:10-18'),
('Who wrote the book of Hebrews?', 'Paul', 'Peter', 'John', 'Unknown', 3, 'The author of Hebrews is unknown, though traditionally attributed to Paul.', 'epistles', 'hard', 'new', 'Hebrews', 'N/A'),
('Which epistle is known as the "Joy Book"?', 'Ephesians', 'Philippians', 'Colossians', 'Galatians', 1, 'Philippians is known as the "Joy Book" because Paul mentions joy and rejoicing throughout.', 'epistles', 'medium', 'new', 'Philippians', 'N/A'),
('Complete this verse: "For God so loved the world that..."', 'he sent his prophets', 'he gave his only Son', 'he created mankind', 'he established his church', 1, 'John 3:16 continues "he gave his one and only Son, that whoever believes in him shall not perish but have eternal life."', 'gospels', 'easy', 'new', 'John', 'John 3:16'),
...
('Who was the first female judge of Israel?', 'Miriam', 'Deborah', 'Esther', 'Ruth', 1, 'Deborah was a prophetess and the only female judge mentioned in the book of Judges.', 'history', 'medium', 'old', 'Judges', 'Judges 4:4'),
('Which king of Israel was known for his wisdom?', 'David', 'Solomon', 'Saul', 'Hezekiah', 1, 'King Solomon was famous for his wisdom, which God granted him when he asked for it.', 'history', 'easy', 'old', '1 Kings', '1 Kings 3:12'),
('Who succeeded Moses as leader of Israel?', 'Aaron', 'Joshua', 'Caleb', 'Samuel', 1, 'Joshua succeeded Moses and led the Israelites into the Promised Land.', 'history', 'medium', 'old', 'Joshua', 'Joshua 1:1-2'),
('Which city''s walls fell down after the Israelites marched around them?', 'Jerusalem', 'Jericho', 'Ai', 'Hebron', 1, 'The walls of Jericho fell down after the Israelites marched around the city for seven days.', 'history', 'medium', 'old', 'Joshua', 'Joshua 6:20'),
...
('Which psalm begins with "The heavens declare the glory of God"?', 'Psalm 18', 'Psalm 19', 'Psalm 20', 'Psalm 21', 1, 'Psalm 19 begins with "The heavens declare the glory of God; the skies proclaim the work of his hands."', 'psalms', 'medium', 'old', 'Psalms', 'Psalm 19:1'),
('Complete this verse: "The Lord is my light and my..."', 'strength', 'salvation', 'shepherd', 'fortress', 1, 'Psalm 27:1 says "The Lord is my light and my salvation—whom shall I fear?"', 'psalms', 'medium', 'old', 'Psalms', 'Psalm 27:1'),
('Which psalm is known as the "Shepherd Psalm"?', 'Psalm 22', 'Psalm 23', 'Psalm 24', 'Psalm 25', 1, 'Psalm 23 is known as the "Shepherd Psalm" because it begins "The Lord is my shepherd."', 'psalms', 'easy', 'old', 'Psalms', 'Psalm 23'),
...
('What is the shortest verse in the Bible?', 'God is love', 'Jesus wept', 'Pray always', 'Be still', 1, '"Jesus wept" (John 11:35) is the shortest verse in the Bible.', 'general', 'easy', 'new', 'John', 'John 11:35'),
('How many books did Moses write?', '3', '4', '5', '6', 2, 'Moses wrote the first five books of the Bible: Genesis, Exodus, Leviticus, Numbers, and Deuteronomy.', 'general', 'medium', 'old', 'General', 'N/A'),
('What is the last book of the Bible?', 'Jude', '3 John', 'Revelation', '2 Peter', 2, 'Revelation is the last book of the Bible, written by the apostle John.', 'general', 'easy', 'new', 'Revelation', 'N/A'),
...
('How many pieces of silver did Judas receive for betraying Jesus?', '20', '25', '30', '35', 2, 'Judas received thirty pieces of silver for betraying Jesus to the chief priests.', 'gospels', 'medium', 'new', 'Matthew', 'Matthew 26:15'),
('What was written on the sign above Jesus on the cross?', 'King of the Jews', 'Jesus of Nazareth, King of the Jews', 'The Son of God', 'The Messiah', 1, 'The sign read "Jesus of Nazareth, King of the Jews" in Hebrew, Latin, and Greek.', 'gospels', 'medium', 'new', 'John', 'John 19:19'),
('How many days was Jesus in the tomb?', '1 day', '2 days', '3 days', '4 days', 2, 'Jesus was in the tomb for three days, rising on the third day.', 'gospels', 'easy', 'new', 'Matthew', 'Matthew 12:40'),
('What was the name of the disciple who replaced Judas?', 'Matthias', 'Barnabas', 'Silas', 'Timothy', 0, 'Matthias was chosen by lot to replace Judas Iscariot as the twelfth apostle.', 'new_testament', 'hard', 'new', 'Acts', 'Acts 1:26'),

-- Additional Old Testament Questions
('What was the name of Isaac''s wife?', 'Rachel', 'Leah', 'Rebecca', 'Sarah', 2, 'Rebecca (also spelled Rebekah) was Isaac''s wife and the mother of Jacob and Esau.', 'old_testament', 'medium', 'old', 'Genesis', 'Genesis 24:67'),
('How many times did Naaman have to dip in the Jordan River to be healed?', '5', '6', '7', '8', 2, 'Naaman had to dip seven times in the Jordan River to be healed of his leprosy.', 'old_testament', 'medium', 'old', '2 Kings', '2 Kings 5:14'),
('What did God provide for the Israelites to eat in the wilderness?', 'Bread', 'Manna', 'Fish', 'Meat', 1, 'God provided manna, a bread-like substance, for the Israelites in the wilderness.', 'old_testament', 'easy', 'old', 'Exodus', 'Exodus 16:31'),
('Who was the mother of Samuel?', 'Hannah', 'Rachel', 'Leah', 'Ruth', 0, 'Hannah was Samuel''s mother who prayed earnestly for a child and dedicated Samuel to God''s service.', 'old_testament', 'medium', 'old', '1 Samuel', '1 Samuel 1:20'),
('What was the name of David''s best friend?', 'Absalom', 'Solomon', 'Jonathan', 'Nathan', 2, 'Jonathan, King Saul''s son, was David''s closest friend and made a covenant with him.', 'old_testament', 'medium', 'old', '1 Samuel', '1 Samuel 18:3'),

-- Additional New Testament Questions
('What was the name of the tax collector who climbed a tree to see Jesus?', 'Matthew', 'Zacchaeus', 'Levi', 'Nicodemus', 1, 'Zacchaeus was the short tax collector who climbed a sycamore tree to see Jesus.', 'gospels', 'medium', 'new', 'Luke', 'Luke 19:2-4'),
('How many lepers did Jesus heal, and how many returned to thank him?', '5 healed, 1 returned', '10 healed, 1 returned', '7 healed, 2 returned', '12 healed, 3 returned', 1, 'Jesus healed ten lepers, but only one returned to thank him.', 'gospels', 'medium', 'new', 'Luke', 'Luke 17:11-19'),
('What was the name of the woman who anointed Jesus'' feet with expensive perfume?', 'Mary Magdalene', 'Mary of Bethany', 'Martha', 'Joanna', 1, 'Mary of Bethany anointed Jesus'' feet with expensive perfume and wiped them with her hair.', 'gospels', 'medium', 'new', 'John', 'John 12:3'),
('Which disciple walked on water with Jesus?', 'John', 'James', 'Peter', 'Andrew', 2, 'Peter walked on water toward Jesus, though he began to sink when he doubted.', 'gospels', 'medium', 'new', 'Matthew', 'Matthew 14:29'),
('What was the name of the man who helped Jesus carry his cross?', 'Simon of Cyrene', 'Simon Peter', 'Simon the Zealot', 'Simon the Pharisee', 0, 'Simon of Cyrene was compelled to help Jesus carry his cross to Golgotha.', 'gospels', 'medium', 'new', 'Matthew', 'Matthew 27:32'),

-- More Epistles Questions
('Which epistle talks about the "whole armor of God"?', 'Romans', 'Ephesians', 'Philippians', 'Colossians', 1, 'Ephesians 6:10-18 describes the whole armor of God that Christians should put on.', 'epistles', 'medium', 'new', 'Ephesians', 'Ephesians 6:10-18'),
('Complete this verse: "Faith comes by hearing, and hearing by..."', 'the word of God', 'prayer', 'the Spirit', 'preaching', 0, 'Romans 10:17 says "Faith comes by hearing, and hearing by the word of God."', 'epistles', 'medium', 'new', 'Romans', 'Romans 10:17'),
('Which book says "God is love"?', '1 Corinthians', '1 John', 'Romans', 'Ephesians', 1, '1 John 4:8 declares that "God is love."', 'epistles', 'easy', 'new', '1 John', '1 John 4:8'),
('In which book do we find the "Hall of Faith"?', 'Romans', 'Hebrews', 'James', '1 Peter', 1, 'Hebrews 11 is known as the "Hall of Faith" chapter, listing Old Testament heroes of faith.', 'epistles', 'medium', 'new', 'Hebrews', 'Hebrews 11'),
('Which book emphasizes that faith without works is dead?', 'Romans', 'Galatians', 'James', 'Ephesians', 2, 'James 2:26 states that "faith without works is dead."', 'epistles', 'medium', 'new', 'James', 'James 2:26'),

-- Additional Challenging Questions
('What was the name of Abraham''s nephew?', 'Isaac', 'Lot', 'Laban', 'Nahor', 1, 'Lot was Abraham''s nephew who lived in Sodom before its destruction.', 'old_testament', 'medium', 'old', 'Genesis', 'Genesis 12:5'),
('How many years did it take to build Solomon''s temple?', '5 years', '7 years', '10 years', '12 years', 1, 'It took seven years to build Solomon''s temple in Jerusalem.', 'history', 'hard', 'old', '1 Kings', '1 Kings 6:38'),
('What was the name of the witch that Saul consulted?', 'The witch of Endor', 'The witch of Babylon', 'The witch of Egypt', 'The witch of Damascus', 0, 'Saul consulted the witch of Endor to speak with the spirit of Samuel.', 'history', 'hard', 'old', '1 Samuel', '1 Samuel 28:7'),
('Which prophet was commanded to marry an unfaithful woman?', 'Isaiah', 'Jeremiah', 'Hosea', 'Amos', 2, 'God commanded Hosea to marry Gomer as a symbol of Israel''s unfaithfulness to God.', 'prophets', 'hard', 'old', 'Hosea', 'Hosea 1:2'),
('What was the name of the place where Jesus ascended to heaven?', 'Mount Sinai', 'Mount of Olives', 'Mount Carmel', 'Mount Hermon', 1, 'Jesus ascended to heaven from the Mount of Olives near Bethany.', 'gospels', 'medium', 'new', 'Acts', 'Acts 1:12');
